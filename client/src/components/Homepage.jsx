    ...
    <div class=" h-[89vh] bg-gradient-to-bl from-transparent via-red-300 to-green-200 dark:bg-gradient-to-tr dark:from-transparent dark:to-transparent ">
        ...
        {(isAuthenticated && (
          <div className=" h-18 hover:cursor-pointer  w-wrap p-2 flex flex-wrap align-middle justify-center rounded-full bg-clip-padding ">
            <div class="rounded-full">
              <img class="h-14 rounded-full" src={user.picture}></img>
            </div>

            <div class=" flex flex-col">
              <span class="flex justify-start px-2 pt-3 font-bold">
                {user.name}
              </span>
              <span class="flex justify-center px-2 text-gray-500 dark:text-gray-200">
                {user.email}
              </span>
            </div>
            <button
              class="float-end right-3 px-4 py-3 pt-2 pl-3 absolute"
              onClick={() =>
      ...
      <div class="home ">
        <div class="flex flex-wrap justify-center gap-5 hidden">
          <button
            type="button"
            class="rounded-lg border border-eden-500 bg-gradient-to-b to-eden-600 hover:from-eden-600 hover:to-eden-700 active:to-eden-700 active:from-eden-800 from-eden-500 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-primary-700 hover:bg-primary-700 focus:ring focus:ring-primary-200 disabled:cursor-not-allowed disabled:border-primary-300 disabled:bg-primary-300"
          >
            Button text
          </button>
          <button
          ...
          <button
            type="button"
            class="rounded-lg border border-primary-100 bg-primary-100 px-5 py-2.5 text-center text-sm font-medium text-primary-600 transition-all hover:border-primary-200 hover:bg-primary-200 focus:ring focus:ring-primary-50 disabled:border-primary-50 disabled:bg-primary-50 disabled:text-primary-400"
          >
            Button text
          </button>
          <button
          ...
          <div class="flex flex-col">
            ...
            >
              <div class="flex flex-wrap justify-start p-3">
                <div
                  class="ml-3 w-full m-3 card-shadow rounded-2xl h-96 border card-border-color overflow-hidden flex flex-col relative text-color"
                  style="background-color: rgb(16, 108, 90); border-color: rgb(20, 135, 109); box-shadow: rgba(255, 255, 255, 0.15) 0px 4px 4px -2px inset; max-width: 310px;"
                >
                  ...
                  <div
                    class="absolute top-1/3 -left-32 -translate-y-1/2 rounded-full w-80 h-80 blur-3xl mix-blend"
                    style="background-color: rgb(34, 167, 135);"
                  ></div>
                  <div
                    class="absolute -top-56 left-1/2 -translate-x-1/2 rounded-full w-96 h-96 blur-3xl mix-blend"
                    style="background-color: rgb(69, 194, 159);"
                  ></div>
                  <div class="absolute top-12 left-6">
                    <div class="flex items-start">
                      <div
                        id="file-size"
                        class="text-6xl font-normal tracking-tighter"
                        style="color: rgb(255, 255, 255);"
                      >
                        0B
                      </div>
                    ...
                    <div class="mt-4 w-64" style="color: rgb(255, 255, 255);">
                      <div class="flex items-center justify-center w-full">
                        <label
                          ...
                          for="dropzone-file"
                          class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer dark:hover:bg-bray-800 "
                        >
                          <div
                          ...
                          >
                            <svg
                              class="w-8 h-8 mb-4 text-gray-300 dark:text-gray-200"
                              aria-hidden="true"
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                              viewBox="0 0 20 16"
                            ...
                            <p class="mb-2 text-sm text-gray-300 dark:text-gray-200">
                              <span class="font-semibold">Click to upload</span>{" "}
                              or drag and drop
                            </p>
                            <p class="text-xs text-gray-300 dark:text-gray-400">
                              DOC, XLS, PDF, TAR, MP3, MP4,
                              <br /> ZIP, SVG, PNG, JPG or GIF <br /> (MAX.
                              200MB)
                            </p>
                          </div>
                          <input
                ...
                <div
                  class="w-full card-shadow m-3 rounded-2xl h-96 border overflow-hidden card-border-color card-background-color"
                  style="max-width: 310px;"
                >
                  <div class="p-4 top-0">
                    <div class="w-full items-end">
                      <div id="files" class="font-medium">
                        Files
                        <input
                          id="submit-button"
                          type="submit"
                          value="Upload"
                          label="submit"
                          class="ml-56 cursor-pointer text-eden-600"
                          disabled={true}
                        />
                      </div>
                    </div>
              ...
              <div class="absolute flex items-center justify-center text-white z-[1] opacity-90 rounded-xl inset-0.5 bg-gradient-to-br from-[#1bb899] to-[#106c5a]">
                <div class="flex flex-col items-center">
                  <div class="max-w-screen-2xl md:px-8">
                    <h2 class="text-center text-xl font-bold bg-gradient-to-r from-neutral-300 to-stone-400 bg-clip-text text-transparent sm:text-2xl lg:text-left lg:text-3xl">
                      Direct Link
                    </h2>
                    <p class="text-center text-gray-300 lg:text-left">
                      You can share the direct link to your file
                    </p>
                  </div>
                    ...
                    <div class="w-72">
                      <div class="relative">
                        ...
                        <input
                          id="target"
                          type="text"
                          class="col-span-6 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-black dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          value="https://go.doshare.me/slug/filename"
                          disabled
                          readonly
                        />
                        <button
                          data-clipboard-action="copy"
                          data-clipboard-text="https://doshare.me/slug/filename"
                          class="absolute end-2 copy top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg p-2 inline-flex items-center justify-center"
                        >
                      ...
                      <span class="font-thin text-black dark:text-black">
                        Note: Files are auto-deleted after 24 Hrs
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div class="flex flex-wrap justify-center shadow-sm rounded-full  m-20">
            <div class="flex flex-col rounded-full justify-center m-20">
              <div class="justify-center gap-5">
                <img
                  src="https://cdn.dribbble.com/users/1243471/screenshots/19917954/media/489417f61466a95e3b15a4f22847e9c0.gif"
                  alt=""
                  class=" w-80 rounded-lg shadow-md shadow-slate-600"
                />
                ...
                <span class="font-thin p-3">
                  <h2 class="text-3xl justify-center text-justify ">
                    {" "}
                    ⛳ Effortlessly Share Your Files, Anywhere
                  </h2>
                  Share documents, photos, and videos instantly. Secure and
                  hassle-free.
                </span>
              </div>
            </div>
      ...
      <div class="flex flex-wrap justify-center gap-5">
        <a href="https://discord.gg/T8VFeyRZWk" target="_blank">
          ...
          >
            Join Our Discord{" "}
            <img src={discordicon} class="h-6 w-6 inline-flex" />
          </button>
        </a>
        <button
          type="button"
        ...
        >
          <img
            src={githubicon}
            alt="GitHub Icon with Link to doshare Repository"
      ...
      <div class="attributes float-end text-lg font-thin">
        Icons by{" "}
        <a target="_blank" class="font-bold" href="https://icons8.com">
          Icons8
        </a>
      </div>
    </div>
...
clipboard.on("success", function (e) {
  ...
  var defaultTooltipMessage = document.getElementById(
    "default-tooltip-message",
  );
  var successTooltipMessage = document.getElementById(
...
async function formSubmit(event) {
  ...
  // Added to the slug for file download
  let uploadedFileName = "";

  const formData = new FormData();
  const inputFileElement = document.querySelector("#dropzone-file");
  ...
  request.onload = function () {
    ...
    if (request.status == 200) {
      document
        ...
        .setAttribute(
          "data-clipboard-text",
          "https://go.doshare.me/" + response.slug + "/" + uploadedFileName,
        );
  ...
  if (inputFileElement.files.length === 1) {
    uploadedFileName = document.getElementById("dropzone-file").files[0].name;
    request.send(new FormData(event.target));
  } else {
    const blob = await downloadZip(inputFileElement.files).blob();
    formData.append("file", blob, uniqueId);
    console.log(blob);
    console.log("Eyyyahhhh");
    uploadedFileName = uniqueId;
    request.send(formData);
    console.log({ uniqueId });
    // document.getElementById("dropzone-file").files[0].name
  }
  ...
  console.log(inputFileElement.files.length);
...
function onlabelclick(event) {
  if (cachedtarray.length == 0) {
    for (
      let i = 0;
      i < document.getElementById("dropzone-file").files.length;
      i++
    ) {
...
function selecthandler(event) {
  ...
  for (var i = 0; i < event.target.files["length"]; i++) {
    ...
    var placeholderurl = "";
    if (
      event.target.files[i].name.split(".").pop() == "jpg" ||
      event.target.files[i].name.split(".").pop() == "png" ||
      event.target.files[i].name.split(".").pop() == "gif"
    ) {
      placeholderurl = imageicon;
    } else if (
      event.target.files[i].name.split(".").pop() == "mp4" ||
      event.target.files[i].name.split(".").pop() == "mp3"
    ) {
      placeholderurl = videoicon;
    } else if (event.target.files[i].name.split(".").pop() == "pdf") {
      placeholderurl = pdficon;
    } else if (
      event.target.files[i].name.split(".").pop() == "doc" ||
      event.target.files[i].name.split(".").pop() == "docx"
    ) {
      placeholderurl = wordicon;
    } else if (
      event.target.files[i].name.split(".").pop() == "xls" ||
      event.target.files[i].name.split(".").pop() == "xlsx"
    ) {
      placeholderurl = xlsicon;
    } else if (
      event.target.files[i].name.split(".").pop() == "zip" ||
      event.target.files[i].name.split(".").pop() == "tar"
    ) {
      ...
      event.target.files[i].name.split(".").pop() == "ppt" ||
      event.target.files[i].name.split(".").pop() == "pptx"
    ) {
    ...
    document.getElementById("file-list").innerHTML +=
      `	<div class="rounded-lg p-3 pb-4 pl-5 relative overflow-hidden" style="background-color: rgb(175, 235, 212);"><div class="absolute w-1.5 top-0 bottom-0 left-0" style="background-color: rgb(20, 135, 109);">
	</div>
	<img src="` +
      placeholderurl +
      `" class="rounded-sm h-8 w-8" alt="" />

	<div class="flex justify-between items-center">
		<div class="font-medium text-sm" style="color: rgb(6, 40, 35);">` +
  ...
  // Disable upload button if files is empty
...
function drophandler(event) {
  ...
  console.log(
    "dropped file size:",
    (event.dataTransfer.files[0].size / 1024 / 1024).toPrecision(3),
    "MB",
  );
  if (event.dataTransfer.files[0].size / 1024 / 1024 / 1024 > 1) {
    document.getElementById("file-size").innerText =
      (event.dataTransfer.files[0].size / 1024 / 1024 / 1024).toPrecision(2) +
      "GB";
    console.log("file size is greater than 1GB");
  } else if (event.dataTransfer.files[0].size / 1024 / 1024 > 1) {
    document.getElementById("file-size").innerText =
      (event.dataTransfer.files[0].size / 1024 / 1024).toPrecision(2) + "MB";
    console.log("file size is greater than 1MB");
  } else if (event.dataTransfer.files[0].size / 1024 > 0.5) {
    document.getElementById("file-size").innerText =
      (event.dataTransfer.files[0].size / 1024).toPrecision(3) + "kB";
    console.log("file size is greater than 1kB");
  } else {
    document.getElementById("file-size").innerText =
      event.dataTransfer.files[0].size + "B";
    console.log("file size is less than 1kB");
  }
  for (var i = 0; i < event.dataTransfer.files.length; i++) {
    ...
    var placeholderurl = "";
    if (
      event.dataTransfer.files[i].name.split(".").pop() == "jpg" ||
      event.dataTransfer.files[0].name.split(".").pop() == "png" ||
      event.dataTransfer.files[0].name.split(".").pop() == "gif"
    ) {
      placeholderurl = imageicon;
    } else if (
      event.dataTransfer.files[i].name.split(".").pop() == "mp4" ||
      event.dataTransfer.files[0].name.split(".").pop() == "mp3"
    ) {
      placeholderurl = videoicon;
    } else if (event.dataTransfer.files[i].name.split(".").pop() == "pdf") {
      placeholderurl = pdficon;
    } else if (
      event.dataTransfer.files[i].name.split(".").pop() == "doc" ||
      event.dataTransfer.files[0].name.split(".").pop() == "docx"
    ) {
      placeholderurl = wordicon;
    } else if (
      event.dataTransfer.files[i].name.split(".").pop() == "xls" ||
      event.dataTransfer.files[0].name.split(".").pop() == "xlsx"
    ) {
      placeholderurl = xlsicon;
    } else if (
      event.dataTransfer.files[i].name.split(".").pop() == "zip" ||
      event.dataTransfer.files[0].name.split(".").pop() == "tar"
    ) {
      placeholderurl = zipicon;
      ...
      event.dataTransfer.files[i].name.split(".").pop() == "ppt" ||
      event.dataTransfer.files[0].name.split(".").pop() == "pptx"
    ) {
      placeholderurl = ppticon;
